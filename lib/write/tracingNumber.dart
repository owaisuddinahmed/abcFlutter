...
class TracingNumber extends StatefulWidget {
  @override
  _TracingNumberState createState() => _TracingNumberState();
}

class _TracingNumberState extends State<TracingNumber> {
                    ...
                    Stack(
                      ...
                      children:<Widget>[
                        Container(
                          ...
                          child:   Image.asset('assets/number/$i.png'),
...
class MyCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint background = Paint()..color = Colors.white10.withOpacity(0.7);
